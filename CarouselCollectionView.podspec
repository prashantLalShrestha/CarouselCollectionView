Pod::Spec.new do |spec|
  spec.name = "CarouselCollectionView"
  spec.version = "1.0.0"
  spec.summary = "CarouselCollectionView is just a simple CoreFoundationKit utility Module"

  spec.description = <<-DESC
  This module contains the tab bar controller with a circular button at center
                   DESC

  spec.homepage = "https://github.com/prashantLalShrestha/CarouselCollectionView"
  ...
  # spec.source = { :git => '' }
  spec.source = { 
    :git => "https://github.com/prashantLalShrestha/CarouselCollectionView.git", :tag => spec.version.to_s
  }
